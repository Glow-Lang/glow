(hash (* (type:arrow (@list (type:name 'Int) (type:name 'Int)) (type:name 'Int)))
      ...
      ((@app + (@app (@dot/type Hand toNat) handA) (@app - 4 (@app (@dot/type Hand toNat) handB))) (type:name 'Int))
      ((@app - 4 (@app (@dot Hand1 toNat) handB)) (type:name 'Int))
      ((@app - 4 (@app (@dot/type Hand toNat) handB)) (type:name 'Int))
      ...
      ((@app (@dot Outcome1 ofNat)
             (@app mod (@app + (@app (@dot Hand1 toNat) handA) (@app - 4 (@app (@dot Hand1 toNat) handB))) 3))
       (type:name 'Outcome0))
      ((@app (@dot/type Hand input) "First player, pick your hand") (type:name 'Hand0))
      ((@app (@dot/type Hand input) "Second player, pick your hand") (type:name 'Hand0))
      ((@app (@dot/type Hand toNat) handA) (type:name-subtype 'Nat (type:name 'Int)))
      ((@app (@dot/type Hand toNat) handB) (type:name-subtype 'Nat (type:name 'Int)))
      ...
      ((@dot/type Hand input) (type:arrow (@list (type:name 'Bytes)) (type:name 'Hand0)))
      ((@dot/type Hand toNat) (type:arrow (@list (type:name 'Hand0)) (type:name-subtype 'Nat (type:name 'Int))))
      ((@dot/type Outcome ofNat) (type:arrow (@list (type:name-subtype 'Nat (type:name 'Int))) (type:name 'Outcome0)))
      ((@make-interaction
        ...
        (@debug-label dlb15)
        (switch outcome
                ((@app-ctor A_Wins) (@debug-label dlb16) (withdraw! A (@record (DefaultToken (@app * 2 wagerAmount)))))
                ((@app-ctor B_Wins) (@debug-label dlb17) (withdraw! B (@record (DefaultToken (@app * 2 wagerAmount)))))
                ((@app-ctor Draw)
                 (@debug-label dlb18)
      ...
      ((λ (tag) (: Hand) (def x (: Hand) (input Hand tag)) x) (type:arrow (@list (type:name 'Bytes)) (type:name 'Hand0)))
      ((λ (tag) (def x (input Hand tag)) x) (type:arrow (@list (type:name 'Bytes)) (type:name 'Hand0)))
      ((λ (tag0) (: Outcome) (def x2 (: Outcome) (input Outcome tag0)) x2)
       (type:arrow (@list (type:name 'Bytes)) (type:name 'Outcome0)))
      ...
      ((λ ((handA : Hand) (handB : Hand))
          ...
          (@app (@dot/type Outcome ofNat)
                (@app mod
                      (@app + (@app (@dot/type Hand toNat) handA) (@app - 4 (@app (@dot/type Hand toNat) handB)))
                      3)))
       (type:arrow (@list (type:name 'Hand0) (type:name 'Hand0)) (type:name 'Outcome0)))
      ((λ ((x0 : Hand)) (: Nat) (switch x0 ((@app-ctor Rock) 0) ((@app-ctor Paper) 1) ((@app-ctor Scissors) 2)))
       (type:arrow (@list (type:name 'Hand0)) (type:name-subtype 'Nat (type:name 'Int))))
      ((λ ((x1 : Nat)) (: Hand) (switch x1 (0 Rock) (1 Paper) (2 Scissors)))
       (type:arrow (@list (type:name-subtype 'Nat (type:name 'Int))) (type:name 'Hand0)))
      ((λ ((x3 : Outcome)) (: Nat) (switch x3 ((@app-ctor B_Wins) 0) ((@app-ctor Draw) 1) ((@app-ctor A_Wins) 2)))
       (type:arrow (@list (type:name 'Outcome0)) (type:name-subtype 'Nat (type:name 'Int))))
      ((λ ((x4 : Nat)) (: Outcome) (switch x4 (0 B_Wins) (1 Draw) (2 A_Wins)))
       (type:arrow (@list (type:name-subtype 'Nat (type:name 'Int))) (type:name 'Outcome0)))
      ((0 B_Wins)
       (type:arrow (@list (type:name 'Int)) (type:tuple (@list (type:record (symdict)) (type:name 'Outcome0)))))
      ((0 Rock) (type:arrow (@list (type:name 'Int)) (type:tuple (@list (type:record (symdict)) (type:name 'Hand0)))))
      ((1 Draw) (type:arrow (@list (type:name 'Int)) (type:tuple (@list (type:record (symdict)) (type:name 'Outcome0)))))
      ((1 Paper) (type:arrow (@list (type:name 'Int)) (type:tuple (@list (type:record (symdict)) (type:name 'Hand0)))))
      ((2 A_Wins)
       (type:arrow (@list (type:name 'Int)) (type:tuple (@list (type:record (symdict)) (type:name 'Outcome0)))))
      ((2 Scissors)
       (type:arrow (@list (type:name 'Int)) (type:tuple (@list (type:record (symdict)) (type:name 'Hand0)))))
      (((@app-ctor A_Wins) 2)
       (type:arrow
        (@list (type:name 'Outcome0))
        (type:tuple (@list (type:record (symdict)) (type:name-subtype 'Nat (type:name 'Int))))))
      (((@app-ctor A_Wins) (@debug-label dlb16) (withdraw! A (@record (DefaultToken (@app * 2 wagerAmount)))))
       (type:arrow (@list (type:name 'Outcome0)) (type:tuple (@list (type:record (symdict)) (type:tuple (@list))))))
      (((@app-ctor B_Wins) 0)
       (type:arrow
        (@list (type:name 'Outcome0))
        (type:tuple (@list (type:record (symdict)) (type:name-subtype 'Nat (type:name 'Int))))))
