...
(define-type InteractionInfo
  (.+
   ...
   {.make: (lambda (name participant-names parameter-names specific-interactions initial-code-block-label)
             { name
               participant-names
               parameter-names
        ...
        (match statement
          ...
          (['def name ['@make-interaction [['@list participant-names ...]] parameter-names labels bodys ...]]
            ...
            (hash-put! interactions name
              (.call InteractionInfo .make name participant-names parameter-names specific-table initial-code-block-label)))
          (['@label label]
            (void))
          (['@debug-label label]
            (void))
