...
-- makeDishonest' l x nm w
  ...
  CtxTrans'-cases-PSOF nm z hp d vNm d' x = {!!}
  ...
  paramSubst-e hp Τ d (AST.var (AST.dsot name₁ {yy})) =
    AST.var (AST.dsot name₁ {{!yy!}})
  
  paramSubst-e hp Τ d (stmnts₁ ;b expr₁) =
      {!!}
  ...
  paramSubst-e hp Τ d (AST.sign x {y} {yy}) = (AST.sign {!x!} {ctxTrans-IsNotConsensus _ d y } {yy})
