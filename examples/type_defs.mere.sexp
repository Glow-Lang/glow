(@module (defdata yn Yes No)
         ...
         (def ordering1
              ...
              (@record (input (λ (tag0)
                                 (: ordering)
                                 (def x2 (: ordering) (input ordering tag0))
                                 x2))
         ...
         (def pair_tuple
              ()
              (λ ((p : (pair 'a 'b))) (: (@tuple 'a 'b)) (switch p ((Pair a b) (@tuple a b)))))
         (def tuple_pair
              ()
              (λ ((t : (@tuple 'a 'b)))
                 (: (pair 'a 'b))
                 (switch t ((@tuple a0 b0) (@app Pair a0 b0)))))
         ...
         (def natural1
              ...
              (@record (input (λ (tag5)
                                 (: natural)
                                 (def x9 (: natural) (input natural tag5))
                                 x9))))
         ...
         (def nothing1
              ...
              (@record (input (λ (tag8)
                                 (: nothing)
                                 (def x12 (: nothing) (input nothing tag8))
                                 x12))
