...
./compiler/project/t/project-1-test.ss
...
> (import "examples/buy_sig.project-1.ss" :mukn/ethereum/t/signing-test :clan/persist/content-addressing)
...
(def ((payForSignature Buyer Seller) digest0 price)
     ...
     (def balances (get-balances [Buyer Seller]))
