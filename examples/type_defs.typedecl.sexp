(symdict ('yn (entry:type #f (@list) (type:name 'yn0)))
         ...
         ('App
          (entry:ctor
           ...
           (typing-scheme
            (symdict)
            (type:arrow
             (@list (type:app (type:name 'lcexpr0) (@list (type:var 'lit)))
                    (type:app (type:name 'lcexpr0) (@list (type:var 'lit))))
             (type:app (type:name 'lcexpr0) (@list (type:var 'lit)))))))
         ('Lit
          (entry:ctor
           #f
         ...
         ('Cons
          (entry:ctor
           ...
           (typing-scheme
            ...
            (type:arrow
             (@list (type:var 'a)
                    (type:app (type:name 'conslist0) (@list (type:var 'a))))
             (type:app (type:name 'conslist0) (@list (type:var 'a)))))))
         ('option
          (entry:type
           #f
           (@list 'a)
           (type:app (type:name 'option0) (@list (type:var 'a)))))
         ('assocpairlist
          (entry:type
           #f
           (@list 'a 'b)
         ...
         ('lcintexpr
          (entry:type
           #f
           (@list)
           (type:app (type:name 'lcexpr0) (@list (type:name 'int)))))
         ...
         ('option_result
          (entry:known
           ...
           (typing-scheme
            (symdict)
            (type:arrow
             (@list (type:app (type:name 'option0) (@list (type:var 'a))))
             (type:app
              (type:name 'result0)
