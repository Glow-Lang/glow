...
@itemize[
    ...
    @item{Will the @literal{.glow} files that I make in the beta be compatible with the next versions of @(Glow)? Normally, yes! If we ever introduce incompatibilities, we'll do our best to drive the community towards a new workflow.}
]
